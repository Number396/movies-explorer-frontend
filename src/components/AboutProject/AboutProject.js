        ...
        <>
            ...
            <section className="aboutProject">
                ...
                <div className="aboutProject__labelContainer">
                    <span className="aboutProject__lable aboutProject__lable_type_back">Back-end</span>
                    <span className="aboutProject__lable aboutProject__lable_type_front">Front-end</span>
                </div>
